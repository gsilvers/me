...
- Medium. Using a purpose designed but modest suite of tools from a provider for example [[https://obsidian.md/pricing][Obsidian]]. Paying for sync here cost 8 USD per month a modest price.
- Large. Using one of the larger premier note taking applications [[https://evernote.com/compare-plans][Evernote]] which ranges from 15 to 18 USD per month for a personal license as of the time of writing.
