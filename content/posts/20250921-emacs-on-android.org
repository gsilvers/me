#+TITLE: Emacs on Android Success
#+DATE: <2025-09-21>
...
[[https://github.com/fornwall/apksigner][APK Signer]]
[[https://termux.dev/en/][Termux]]
[[https://github.com/termux][Termux Repo]]
[[https://grapheneos.org][Graphene OS]]

I also partook in some internet discussion and referenced some great articles and posts:
[[https://www.emacswiki.org/emacs/EmacsOnAndroid][Emacs Wiki Android Page]]
[[https://sourceforge.net/projects/android-ports-for-gnu-emacs/files/][Wei's Emacs Builds]]
[[https://kristofferbalintona.me/posts/202505291438/][Kristoffer's Excellent Blog Post]]
[[https://www.reddit.com/r/emacs/comments/1kykjq2/emacs_on_android_is_pretty_good/][Reddit Discussion On That Post]]
[[https://protesilaos.com/codelog/2025-09-07-prot-asks-greg-emacs-android-fishing-dogs-pennsylvania/][My Conversation With Prot]]
[[https://marek-g.github.io/posts/tips_and_tricks/emacs_on_android/][Marek's page]]
...
:PROPERTIES:
:CUSTOM_ID: some-notes-for-others
:END:
...
1. Sign Termux. You need to have termux signed with emacs's key.
   ...
   3. Download the [[https://github.com/termux/termux-app/releases][termux apk]]
   4. Download (raw) the [[https://git.savannah.gnu.org/cgit/emacs.git/tree/java/emacs.keystore][emacs signing key]]
...
3. Install emacs.
   1. Download and install the proper emacs build from [[https://sourceforge.net/projects/android-ports-for-gnu-emacs/files/termux][Wei's Emacs Builds]]. This is critical. Wei's emacs builds put the same =sharedUserId= from termux in the emacs =AndroidManifest.xml=.
...
:CUSTOM_ID: and-so-on
:END:
And that's it so far. This is great. Emacs and frankly programming on a desktop are wonderful. What's better is programming on the go. I've been able to replace [[https://www.strava.com/][Strava]].
