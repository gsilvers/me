...
:PROPERTIES:
:CUSTOM_ID: continue-to-improve-the-deck
:END:
...
Luckily virtualization offers easy ways to encapsulate a more secure environment within a less secure one. It seems like [[https://help.gnome.org/users/gnome-boxes/stable/][Gnome Boxes]] is available as a flatpak and can be used to set up Qemu or KMS virtual machines.

Since this is a bit of an unreliable environment we can use something like [[https://nixos.org/][Nix]] to allow us to quickly recover our configuration if steamos somehow eats our vm. I've seen alot of buzz around Nix and I'm eager to give the configuration declaration a try.

* What's needed
:PROPERTIES:
:CUSTOM_ID: whats-needed
:END:
...
* Off to the races
:PROPERTIES:
:CUSTOM_ID: off-to-the-races
:END:
Installation is the same as any Linux distro. Once you get done you're facing:

#+caption: nixos running in vm
[[/me/20230923/nixosvm.png]]

And here we go. I'm in and reading [[https://nixos.org/manual/nixos/stable/#sec-configuration-syntax][the docs]] and it seems pretty easy at first glance. Up first you can easily try applications using:
...
#+caption: trying to add Emacs
[[/me/20230923/addemacs.png]]

and then run nixos-rebuild. And....

#+caption: it works!
[[/me/20230923/itworks.png]]
