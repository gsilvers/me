...
:END:
This post is an older blog article I created when I tried out Medium a few years ago. The [[https://gregpoked.medium.com/connecting-dbeaver-to-oracle-free-cloud-tier-database-with-keyfiles-ed835f990031][article]] is still on the internet but I detest the fact that Medium articles are not plain text, and not portable. This is just an attempt on my part to convert said article to markdown and get it back under my control.
...
I'd love to [[https://hachyderm.io/@pokeypoke][speak about it with anyone]] about updates please reach out and I will post your updates with credits.

* Original Article
:PROPERTIES:
:CUSTOM_ID: original-article
:END:
** Connecting DBeaver to Oracle Free Cloud Tier Database (With Keyfiles)
:PROPERTIES:
:CUSTOM_ID: connecting-dbeaver-to-oracle-free-cloud-tier-database-with-keyfiles
:END:
...
#+caption: Image of Oracle Cloud Dashboard with Database Showing
[[/me/20230920/image_1.webp]]
...
#+caption: Image showing unzipped file contents including oracle wallet files
[[/me/20230920/image_2.webp]]
...
#+caption: Image showing DBeaver connection drop down menu with Oracle logo highlighter
[[/me/20230920/image_3.webp]]
...
#+caption: Image showing connection pop up with TNS selected
[[/me/20230920/image_4.webp]]
...
#+caption: Image showing the same connection pop up with password and user populated
[[/me/20230920/image_5.webp]]
...
#+caption: Image showing the driver properties tab of this window
[[/me/20230920/image_6.webp]]
...
#+caption: Same image showing the keystore value changed
[[/me/20230920/image_7.webp]]
...
#+caption: Screenshot of DBeaver SQL sheet with a sample query completed IE select 1 from dual;
[[/me/20230920/image_8.webp]]
